...
import com.erikriosetiawan.recursiveleague.activities.TeamDetailsFavoriteActivity
import com.erikriosetiawan.recursiveleague.models.Team
import com.squareup.picasso.Picasso

class FavoriteTeamAdapter(private val context: Context, private val teams: List<Team>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.bindItem(teams[position]) {
            val dataIntent = Intent(context, TeamDetailsFavoriteActivity::class.java)
            dataIntent.putExtra(TeamDetailsFavoriteActivity.TEAM_KEY, it)
